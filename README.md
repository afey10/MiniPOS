# MiniCart — Marketing Website

A simple, static 4-page website (Home, Features, Pricing, Contact) for selling MiniCart as a product.
No build step needed — it's plain HTML/CSS/JS. Uses your real MiniCart logo and real screenshots
...
5. `assets/minicart-wordmark-on-blue.png` (the horizontal logo lockup on a blue background) isn't
...
1. Go to https://github.com/new and create a **new, separate** repository (for example `minicart-website`). Don't upload this into your existing POS app repo — this is a different project.
...
6. Vercel will give you a URL like `minicart-website.vercel.app`. You can later connect a custom domain (e.g. `minicart.com` or similar) from the project's Settings → Domains tab.
